...
### Fixed
- Rebuild Android release with the complete fixed keystore secret.

## [1.4.49] - 2026-04-25

### Fixed
- Android release signing now strips non-base64 characters from `KEYSTORE_BASE64` before decoding.

## [1.4.48] - 2026-04-25

### Fixed
- Rebuild Android release after updating the keystore secret.

## [1.4.47] - 2026-04-25

### Fixed
- Rebuild Android release after updating the keystore base64 secret.
...
### Fixed
- Android release builds now require fixed keystore signing in CI to prevent package signature conflicts in future updates.

## [1.4.44] - 2026-04-25

### Added
- Animated first-run tutorial explaining the main social and media features.

### Changed
- Ranking now displays watched time as minutes/hours instead of decimal hours.

## [1.4.43] - 2026-04-25

### Fixed
- Fixed release build by adding the missing update installer localization getter.

## [1.4.42] - 2026-04-25

### Fixed
- Fixed Android in-app update installation after APK download.
- Opens Android "install unknown apps" settings when permission is missing.
- Removed visible Chinese text from update download/install dialogs.
