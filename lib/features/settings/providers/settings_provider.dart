...
class SettingsProvider extends ChangeNotifier {
  ...
  void _loadSettings() {
    ...
    _showFps = prefs.getBool(_keyShowFps) ?? false;
    _showClock = prefs.getBool(_keyShowClock) ?? false;
    _showNetworkSpeed = prefs.getBool(_keyShowNetworkSpeed) ?? false;
    _showVideoInfo = prefs.getBool(_keyShowVideoInfo) ?? false;
