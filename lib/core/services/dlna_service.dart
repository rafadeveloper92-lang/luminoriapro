  ...
  Future<void> _generateDeviceUuid() async {
    try {
      ...
      if (Platform.isAndroid) {
        ...
        _deviceName = 'Luminoria (${info.model})';
      } else if (Platform.isWindows) {
        final info = await deviceInfo.windowsInfo;
        _deviceUuid = 'uuid:${info.deviceId}-lotus-iptv';
        _deviceName = 'Luminoria (${info.computerName})';
      } else {
...
SERVER: Luminoria/1.0 UPnP/1.0 DLNADOC/1.50\r
...
''';
  ...
  Future<void> _handleEventSubscription(HttpRequest request) async {
    if (request.method == 'SUBSCRIBE') {
      ...
      request.response.headers.set('Server', 'Luminoria/1.0 UPnP/1.0');
...
<root xmlns="urn:schemas-upnp-org:device-1-0" xmlns:dlna="urn:schemas-dlna-org:device-1-0">
  ...
  <device>
    ...
    <manufacturer>Luminoria</manufacturer>
    <manufacturerURL>https://github.com/rafadeveloper92-lang/luminoriapro</manufacturerURL>
    <modelDescription>Luminoria Media Renderer</modelDescription>
    <modelName>Luminoria</modelName>
    <modelNumber>1.0</modelNumber>
    <modelURL>https://github.com/rafadeveloper92-lang/luminoriapro</modelURL>
    <UDN>$_deviceUuid</UDN>
