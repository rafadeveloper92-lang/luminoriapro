...
<p align="center">
  <img src="assets/icons/app_icon.png" width="120" alt="Luminoria Logo">
</p>
...
Luminoria is a modern, high-performance IPTV player built with Flutter. Features a beautiful Lotus-themed UI with pink/purple gradient accents(Split-screen support), optimized for seamless viewing across desktop, mobile, TV, and iOS platforms.
...
- **iOS**: IPA (unsigned - requires sideloading with AltStore or similar)
...
- **iOS**: iPhone and iPad support with optimized touch controls
...
- Cast videos from other devices to Luminoria
